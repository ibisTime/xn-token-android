...
public class AuthenticateActivity extends AbsActivity {
    ...
    private void authenticate() {
        ...
        object.put("returnUrl", "orangecoin://certify.back");
        ...
        Call call = RetrofitUtils.getBaseAPiService().successRequest("805195", StringUtils.getRequestJsonString(object));
        addCall(call);
        showLoadingDialog();
    ...
    private void check() {
        ...
        Call call = RetrofitUtils.getBaseAPiService().successRequest("805196", StringUtils.getRequestJsonString(object));
        addCall(call);
        showLoadingDialog();
        call.enqueue(new BaseResponseModelCallBack<IsSuccessModes>(this) {
            @Override
