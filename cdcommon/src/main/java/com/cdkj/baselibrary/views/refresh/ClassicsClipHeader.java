package com.cdkj.baselibrary.views.refresh;
...
public class ClassicsClipHeader extends RelativeLayout implements RefreshHeader {
    ...
    public ClassicsClipHeader(Context context) {
        super(context);
        this.initView(context, null);
    }

    public ClassicsClipHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public ClassicsClipHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public ClassicsClipHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mHeaderText.setTextColor(ContextCompat.getColor(getContext(),com.cdkj.baselibrary.R.color.white));
        ...
        if (isInEditMode()) {
            ...
            mHeaderText.setText(com.cdkj.baselibrary.R.string.refreshing);
        } else {
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlArrowDrawable)) {
            ...
            mArrowDrawable.parserColors(ContextCompat.getColor(getContext(),com.cdkj.baselibrary.R.color.white));
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlProgressDrawable)) {
            ...
            mProgressDrawable.setColor(ContextCompat.getColor(getContext(),com.cdkj.baselibrary.R.color.white));
    ...
    public int onFinish(RefreshLayout layout, boolean success) {
        ...
        mProgressView.setVisibility(GONE);
        if (success) {
            mHeaderText.setText(com.cdkj.baselibrary.R.string.refresh_success);
            setLastUpdateTime(new Date());
        } else {
            mHeaderText.setText(com.cdkj.baselibrary.R.string.refresh_failure);
        }
...
//                restoreRefreshLayoutBackground();
            ...
            case ReleaseToRefresh:
                mHeaderText.setText(com.cdkj.baselibrary.R.string.now_can_refresh);
...
//                replaceRefreshLayoutBackground(refreshLayout);
            ...
            case Loading:
                ...
                mProgressView.setVisibility(GONE);
                mLastUpdateText.setVisibility(GONE);
                mHeaderText.setText(com.cdkj.baselibrary.R.string.loading);
                break;
        }
    }

    public ClassicsClipHeader setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }

    public ClassicsClipHeader setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }

    public ClassicsClipHeader setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }

    public ClassicsClipHeader setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }

    public ClassicsClipHeader setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }

    public ClassicsClipHeader setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public ClassicsClipHeader setLastUpdateTime(Date time) {
        mLastTime = time;
        DateFormat mFormat =
    ...
    public ClassicsClipHeader setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public ClassicsClipHeader setAccentColor(int accentColor) {
        if (mArrowDrawable != null) {
