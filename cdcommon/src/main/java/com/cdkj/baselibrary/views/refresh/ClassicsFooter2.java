...
public class ClassicsFooter2 extends RelativeLayout implements RefreshFooter {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBottomText.setText(com.cdkj.baselibrary.R.string.pull_up_to_load_more);
...
//        }
    ...
    public int onFinish(RefreshLayout layout, boolean success) {
        if (!mLoadmoreFinished) {
            ...
            mProgressView.setVisibility(GONE);
            if (success) {
                mBottomText.setText(com.cdkj.baselibrary.R.string.load_success);
            } else {
                mBottomText.setText(com.cdkj.baselibrary.R.string.load_fail);
            }
            return 500;
        }
        return 0;
    ...
    public boolean setLoadmoreFinished(boolean finished) {
        if (mLoadmoreFinished != finished) {
            ...
            if (finished) {
                mBottomText.setText(com.cdkj.baselibrary.R.string.no_more_data);
            } else {
                mBottomText.setText(com.cdkj.baselibrary.R.string.pull_up_to_load_more);
            }
            if (mProgressDrawable != null) {
...
//                    restoreRefreshLayoutBackground();
                ...
                case Loading:
                    mArrowView.setVisibility(GONE);
                    mBottomText.setText(com.cdkj.baselibrary.R.string.loading);
                    break;
                case ReleaseToLoad:
                    mBottomText.setText(com.cdkj.baselibrary.R.string.release_to_load_more);
                    mArrowView.animate().rotation(0);
//                    replaceRefreshLayoutBackground(refreshLayout);
                    break;
                case Refreshing:
                    mBottomText.setText(com.cdkj.baselibrary.R.string.refreshing);
                    mProgressView.setVisibility(GONE);
                    mArrowView.setVisibility(GONE);
                    break;
            }
...
//    }
    ...
    public ClassicsFooter2 setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }

    public ClassicsFooter2 setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }

    public ClassicsFooter2 setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }

    public ClassicsFooter2 setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }

    public ClassicsFooter2 setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }

    public ClassicsFooter2 setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public ClassicsFooter2 setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public ClassicsFooter2 setAccentColor(int accentColor) {
    ...
    public ClassicsFooter2 setPrimaryColor(int primaryColor) {
