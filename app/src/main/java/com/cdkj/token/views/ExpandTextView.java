...
public class ExpandTextView extends TextView {
    ...
    private String TEXT_EXPAND = getContext().getString(R.string.expand_text_more);
    private String TEXT_CLOSE = getContext().getString(R.string.expand_text_less);
