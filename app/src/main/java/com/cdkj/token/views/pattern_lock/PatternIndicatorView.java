...
//        drawLinkedLine(canvas);
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.normalColor = ta.getColor(R.styleable.PatternIndicatorView_piv_color, PatternLockViewConfig.getDefaultNormalColor());
        this.fillColor = ta.getColor(R.styleable.PatternIndicatorView_piv_fillColor, PatternLockViewConfig.getDefaultFillColor());
        this.hitColor = ta.getColor(R.styleable.PatternIndicatorView_piv_hitColor, PatternLockViewConfig.getDefaultHitColor());
        this.errorColor = ta.getColor(R.styleable.PatternIndicatorView_piv_errorColor, PatternLockViewConfig.getDefaultErrorColor());
        this.lineWidth = ta.getDimension(R.styleable.PatternIndicatorView_piv_lineWidth, PatternLockViewConfig.getDefaultLineWidth(getResources()));
    ...
    private void drawCells(Canvas canvas) {
        ...
        for (int i = 0; i < this.cellBeanList.size(); i++) {
            LockPointModel item = this.cellBeanList.get(i);
            if (item.isHit) {
