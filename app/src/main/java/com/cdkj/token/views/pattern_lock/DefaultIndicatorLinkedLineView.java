...
public class DefaultIndicatorLinkedLineView implements IIndicatorLinkedLineView {
    ...
    @Override
    public void draw(@NonNull Canvas canvas, @Nullable List<Integer> hitList, @NonNull List<LockPointModel> cellBeanList, boolean isError) {
        ...
        final LockPointModel first = cellBeanList.get(hitList.get(0));
