...
import com.cdkj.token.databinding.FragmentBackup2Binding;
...
public class BackupFragment2 extends BaseLazyFragment {

    private FragmentBackup2Binding mBinding;
     ...
     * @return
     */
    public static BackupFragment2 getInstance(String[] wordsList) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.fragment_backup2, null ,false);
