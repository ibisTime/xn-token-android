...
import com.cdkj.token.adapter.AddPriChoiceAdapter;
...
public class AddPriChoiceCoinActivity extends AbsRefreshListActivity {

    private AddPriChoiceAdapter addChoiceAdapter;
    ...
    public static void open(Context context) {
        ...
        context.startActivity(new Intent(context, AddPriChoiceCoinActivity.class));
    }
...
//        mlLocalCoinCachePresenter.getCoinList(this);
    ...
    public RecyclerView.Adapter getListAdapter(List listData) {
        addChoiceAdapter = new AddPriChoiceAdapter(listData);
    ...
    public void getListRequest(int pageindex, int limit, boolean isShowDialog) {
        mlLocalCoinCachePresenter.getCoinList(AddPriChoiceCoinActivity.this);
    }
